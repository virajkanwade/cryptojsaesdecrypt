...
function handleRequest(request, response){
    ...
    var key = queryAsObject['key'];
    var data_json = queryAsObject['data_json'];
    var dramavalue = JSON.parse(CryptoJS.AES.decrypt(data_json, key, {format: CryptoJSAesJson}).toString(CryptoJS.enc.Utf8));

    response.end(dramavalue);
}
